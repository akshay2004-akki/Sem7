...
import Indent from "../utility/Indent";

function Hero() {
  return (
    <>
      <section className="relative overflow-hidden bg-black sm:pb-16 lg:pb-20 xl:pb-24">
    <div className="mx-auto relative sm:px-6 lg:px-8 max-w-7xl">
        {/* 1. The <Indent> component was removed */}
        {/* 2. Added responsive widths (lg:w-1/2) to both columns */}
        <div className="flex flex-col pt-32 lg:flex lg:flex-row items-center gap-12 lg:gap-20">
            {/* First Column (Text Content) - now with width defined */}
                ...
                <div className="mt-8 sm:mt-12">
                    ...
                    <div className="flex items-center mt-3">
                        <div className="flex">
                            ...
                            {/* ...omitted other stars for brevity... */}
                        </div>
            ...
            {/* Second Column (Image Content) - also with width defined */}
