...
function Hero() {
  return (
    <>
      <section className="relative overflow-hidden bg-black pb-12 pt-24 sm:pb-16 sm:pt-28 lg:pb-20 lg:pt-32 xl:pb-24">
        <div className="mx-auto relative px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
            ...
            <div className="w-full text-center lg:w-1/2 lg:text-left">
              ...
              <div className="mt-8 sm:mt-12">
                ...
                {/* Centered the ratings on mobile, left-aligned on large screens */}
                <div className="flex items-center justify-center mt-3 lg:justify-start">
                  <div className="flex">
                    {/* SVG Star Icons (repeating 5 times for a full 5-star rating) */}
                    {[...Array(5)].map((_, i) => (
            ...
            <div className="w-full lg:w-1/2 relative max-w-lg lg:max-w-2xl">
              ...
              <img className="relative w-full max-w-md mx-auto" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/hero/2/illustration.png" alt="Developers collaborating" />
            </div>
          </div>
        </div>
      </section>
