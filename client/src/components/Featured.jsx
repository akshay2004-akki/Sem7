...
function Featured() {
  return (
    <div className="w-full min-h-[100vh] bg-black text-white flex flex-col items-center py-20 px-5 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10rem] left-[-10rem] w-96 h-96 bg-cyan-500/40 rounded-full filter blur-3xl opacity-50"></div>
      <div className="absolute bottom-[-10rem] right-[-10rem] w-96 h-96 bg-purple-600/40 rounded-full filter blur-3xl opacity-50"></div>
