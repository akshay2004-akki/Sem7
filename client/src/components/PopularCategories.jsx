...
const categories = [
  { label: "Frontend", title: "Web Development", description: "Build websites and apps", icon: <Code size={40} /> },
  { label: "AI/ML", title: "Artificial Intelligence", description: "Learn machine learning & AI", icon: <BrainCircuit size={40} /> },
  { label: "Data", title: "Data Science", description: "Analyze data & visualize insights", icon: <BarChart3 size={40} /> },
  { label: "Cloud", title: "Cloud Computing", description: "Scale apps with cloud infra", icon: <Cloud size={40} /> },
  { label: "Design", title: "UI/UX Design", description: "Craft beautiful user experiences", icon: <PenTool size={40} /> },
  { label: "GenAI", title: "Generative AI", description: "Explore LLMs and creative AI", icon: <Bot size={40} /> },
];
